...
import com.infoevent.joparis.event.schedules.EventStatusUpdater;
import com.infoevent.joparis.event.services.EventService;
import com.infoevent.joparis.venue.entities.Venue;
import com.infoevent.joparis.venue.services.VenueService;
...
public class EventController {
    ...
    public ResponseEntity<?> createEvent(@RequestBody Event event) {
        ...
        event.setSeatAvailable(event.getVenue().getCapacity());
    ...
    public ResponseEntity<List<Event>> findEventsByVenueID(@PathVariable Long venueID) {
        ...
        List<Event> events = eventService.findEventsByVenue(venue.orElse(null));
        return ResponseEntity.ok(events);
    }
    ...
    public ResponseEntity<Boolean> checkEventAvailability(
        ...
        Optional<Venue> venue = venueService.findVenueById(venueID);
        boolean isAvailable = eventService.checkEventAvailability(venue.orElse(null), startTime, endTime, date);
